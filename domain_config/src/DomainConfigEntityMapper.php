...
/**
 * @file
 * Contains \Drupal\domain_config\DomainConfigEntityMapper.
 */
 ...
 */
class DomainConfigEntityMapper extends DomainConfigNamesMapper {
  ...
  public function getOperations() {
    return array(
      'list' => array(
        'title' => $this->t('List'),
        'url' => Url::fromRoute('domain_config.entity_list', [
  ...
  public function getOverviewRouteName() {
    return 'entity.' . $this->entityType . '.domain_config_overview';
  }
