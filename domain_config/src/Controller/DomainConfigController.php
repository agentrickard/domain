...
/**
 * @file
 * Contains \Drupal\domain_config\Controller\DomainConfigController.
 */
 ...
 */
class DomainConfigController extends ControllerBase {
  ...
  /**
   * Constructs a DomainConfigController.
   *
   ...
   *   The language manager.
   */
  public function __construct(DomainConfigMapperManagerInterface $config_mapper_manager, AccessManagerInterface $access_manager, RequestMatcherInterface $router, InboundPathProcessorInterface $path_processor, AccountInterface $account, LanguageManagerInterface $language_manager) {
  ...
  public function itemPage(Request $request, RouteMatchInterface $route_match, $plugin_id) {
    /** @var \Drupal\domain_config\DomainConfigMapperInterface $mapper */
    ...
    // DomainConfigMapperInterface::populateFromRouteMatch() for the different languages.
    ...
    foreach ($languages as $language) {
      ...
      // DomainConfigMapperInterface::getAddRouteParameters(), for example,
