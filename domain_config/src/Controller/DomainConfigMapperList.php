...
/**
 * @file
 * Contains \Drupal\domain_config\Controller\DomainConfigMapperList.
 */

namespace Drupal\domain_config\Controller;

use Drupal\domain_config\DomainConfigMapperInterface;
use Drupal\Core\Controller\ControllerBase;
use Symfony\Component\DependencyInjection\ContainerInterface;

/**
 * Defines the domain configuration mapper list.
 *
 * Groups all defined configuration mapper instances by weight.
 */
class DomainConfigMapperList extends ControllerBase {

  /**
   * A array of configuration mapper instances.
   *
   * @var \Drupal\domain_config\ConfigMapperInterface[]
   */
  protected $mappers;

  /**
   * Constructs a new DomainConfigMapperList object.
   *
   * @param \Drupal\domain_config\DomainConfigMapperInterface[] $mappers
  ...
  public static function create(ContainerInterface $container) {
    return new static(
      $container->get('plugin.manager.domain_config.mapper')->getMappers()
    );
  }
   ...
   *
   * @param \Drupal\domain_config\DomainConfigMapperInterface $mapper
   *   The mapper.
   *
   * @return array
   *   A render array structure of fields for this mapper.
   */
  public function buildRow(DomainConfigMapperInterface $mapper) {
   ...
   *
   * @param \Drupal\domain_config\ConfigMapperInterface $mapper
   *   The mapper.
   *
   * @return array
   ...
   */
  protected function buildOperations(DomainConfigMapperInterface $mapper) {
