...
/**
 * @file
 * Contains \Drupal\domain_config\DomainConfigNamesMapper.
 */
 ...
 */
class DomainConfigNamesMapper extends PluginBase implements DomainConfigMapperInterface, ContainerFactoryPluginInterface {
   ...
   * @param \Drupal\domain_config\DomainConfigMapperManagerInterface $config_mapper_manager
   *   The mapper plugin discovery service.
   ...
   */
  public function __construct($plugin_id, $plugin_definition, ConfigFactoryInterface $config_factory, TypedConfigManagerInterface $typed_config, LocaleConfigManager $locale_config_manager, DomainConfigMapperManagerInterface $config_mapper_manager, RouteProviderInterface $route_provider, TranslationInterface $string_translation, LanguageManagerInterface $language_manager) {
  ...
  public function getTitle() {
    // A title from a *.domain_config.yml. Should be translated for
  ...
  public function getOverviewRouteName() {
    return 'domain_config.item.overview.' . $this->getBaseRouteName();
  }
  ...
  public function getOverviewRoute() {
    $route = new Route(
      ...
      array('_domain_config_overview_access' => 'TRUE')
    );
  ...
  public function getAddRouteName() {
    return 'domain_config.item.add.' . $this->getBaseRouteName();
  }
  ...
  public function getAddRoute() {
    $route = new Route(
      $this->getBaseRoute()->getPath() . '/domain-config/{langcode}/add',
      array(
        '_form' => '\Drupal\domain_config\Form\DomainConfigAddForm',
        'plugin_id' => $this->getPluginId(),
      ),
      array('_domain_config_form_access' => 'TRUE')
    );
    $this->processRoute($route);
    return $route;
  }
  ...
  public function getEditRouteName() {
    return 'domain_config.item.edit.' . $this->getBaseRouteName();
  }
  ...
  public function getEditRoute() {
    $route = new Route(
      $this->getBaseRoute()->getPath() . '/domain-config/{langcode}/edit',
      array(
  ...
  public function getDeleteRouteName() {
    return 'domain_config.item.delete.' . $this->getBaseRouteName();
  }
  ...
  public function getDeleteRoute() {
    $route = new Route(
      $this->getBaseRoute()->getPath() . '/domain-config/{langcode}/delete',
      array(
