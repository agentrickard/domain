...
/**
 * @file
 * Contains \Drupal\domain_config\DomainConfigFieldMapper.
 */
 ...
 */
class DomainConfigFieldMapper extends DomainConfigEntityMapper {
  ...
  public function getOverviewRouteName() {
    return 'entity.field_config.domain_config_overview.' . $this->pluginDefinition['base_entity_type'];
  }
