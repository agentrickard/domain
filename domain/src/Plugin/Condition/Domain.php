...
class Domain extends ConditionPluginBase implements ContainerFactoryPluginInterface {
  ...
  public function buildConfigurationForm(array $form, FormStateInterface $form_state) {
    $form['domains'] = array(
      ...
      '#options' => array_map('\Drupal\Component\Utility\Html::escape', \Drupal::service('domain.storage')->loadOptionsList()),
  ...
  public function summary() {
    ...
    $domains = array_intersect_key(\Drupal::service('domain.storage')->loadOptionsList(), $this->configuration['domains']);
    if (count($domains) > 1) {
